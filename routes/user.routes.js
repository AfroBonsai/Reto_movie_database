...
router.get("/:_id", auth, users.findOne); // Show user information
router.get("/", auth, users.findAll); // Show all users

router.put("/:_id", auth, users.update); // Update user information
